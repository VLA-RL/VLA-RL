    ...
    def update(self, loss_dict):
        ...
        normalized_loss.update({'total_loss': 
            ...
            #   0.05*normalized_loss['item_loss'] +
                0.05*normalized_loss['object_position_loss'] +
                #   0.1*normalized_loss['target_position_loss'] +
                    0.05*normalized_loss['stage_loss'] +
                      0.1*normalized_loss['action_position_loss'] + 0.1*normalized_loss['action_orientation_loss'] + 0.1*normalized_loss['action_open_loss']})
