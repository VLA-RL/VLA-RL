#From https://github.com/stepjam/RLBench/blob/master/rlbench/dataset_generator.py
...
def parse_args():
    ...
    parser.add_argument('--save_path', type=str, default=cfg.raw_data_dir, help='Where to save the demos.')
    parser.add_argument('--tasks', nargs='*', default=cfg.task_names, help='The tasks to collect. If empty, all tasks are collected.')
    parser.add_argument('--image_size', nargs=2, type=int, default=cfg.image_size, help='The size of the images to save.')
    ...
    parser.add_argument('--processes', type=int, default=3, help='The number of parallel processes during collection.')
    parser.add_argument('--episodes_per_task', type=int, default=3, help='The number of episodes to collect per task.')
    parser.add_argument('--variations', type=int, default=10, help='Number of variations to collect per task. -1 for all.')
